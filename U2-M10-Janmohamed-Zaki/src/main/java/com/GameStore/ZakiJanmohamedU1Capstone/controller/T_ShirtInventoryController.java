...
public class T_ShirtInventoryController {
    ...
    //getById
    @RequestMapping(value = "/t_shirt/id/{id}", method = RequestMethod.GET)
    @ResponseStatus(HttpStatus.OK)
    public T_Shirt getT_shirtById (@PathVariable int id){
        return inventoryService.getT_shirtById(id);
    }
    ...
    //getByColor
    @RequestMapping(value = "/t_shirt/color/{color}", method = RequestMethod.GET)
    @ResponseStatus(HttpStatus.OK)
    ...
    //getBySize
    @RequestMapping(value = "/t_shirt/size/{size}", method = RequestMethod.GET)
    @ResponseStatus(HttpStatus.OK)
    ...
    //update
    @RequestMapping(value = "/t_shirt/{id}", method =RequestMethod.PUT)
    @ResponseStatus (value = HttpStatus.OK)
    public void updateT_shirt (@PathVariable int id, @RequestBody T_Shirt t_shirt){
        inventoryService.updates_T_shirt(t_shirt);
    }

    //delete
    @RequestMapping(value = "/t_shirt/delete/{t_shirt_id}", method = RequestMethod.DELETE)
